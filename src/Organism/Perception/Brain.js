...
class Brain {
  constructor(owner) {
    ...
    this.decisions[CellStates.healer.name] = Decision.neutral;
    this.decisions[CellStates.camo.name] = Decision.neutral;
  }
  ...
  randomizeDecisions() {
    ...
    this.decisions[CellStates.camo.name] = Decision.getRandom();
  }
